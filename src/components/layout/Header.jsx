            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                  ...
                  <Link to="/products/category/1" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Ghee</Link>
                  <Link to="/products/category/2" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Honey</Link>
                  <Link to="/products/category/3" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Nut Butters</Link>
                  <Link to="/products/category/4" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Stone Pressed Oils</Link>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              {isShopOpen && (
                <div className="pl-4 space-y-2">
                  ...
                  <Link to="/products/ghee" className="block text-white hover:text-gray-200 py-1">Ghee</Link>
                  <Link to="/products/honey" className="block text-white hover:text-gray-200 py-1">Honey</Link>
                  <Link to="/products/nut-butters" className="block text-white hover:text-gray-200 py-1">Nut Butters</Link>
                  <Link to="/products/oils" className="block text-white hover:text-gray-200 py-1">Stone Pressed Oils</Link>
                </div>
              )}
            </div>
