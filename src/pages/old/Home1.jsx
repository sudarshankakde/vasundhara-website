...
function Home() {
  const collections = [
    { title: "Ghee", image: "/placeholder.svg", link: "/products/category/ghee" },
    { title: "Honey", image: "/placeholder.svg", link: "/products/category/honey" },
    { title: "Nut Butters", image: "/placeholder.svg", link: "/products/category/nut-butters" },
    { title: "Stone Pressed Oils", image: "/placeholder.svg", link: "/products/category/oils" },
    { title: "Gifting", image: "/placeholder.svg", link: "/products/category/gifting" },
    { title: "Super Saver Combos", image: "/placeholder.svg", link: "/products/category/combos" }
  ];
      ...
      <section className="relative h-[600px] bg-[#ffd700]">
        <div className="container mx-auto px-4 h-full flex items-center">
          <div className="max-w-xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">THE GOLDEN GOODNESS</h1>
            <p className="text-xl mb-8">Sweet Love लेते जाइए</p>
