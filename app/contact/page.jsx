    ...
    <div className="py-16 bg-[#ffe4e1]">
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-center mb-12">We'd love to hear about your experience with Vasundhara. Please get in touch with any comments, suggestions or questions you might have.</p>
